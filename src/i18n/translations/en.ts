export const en = {
  ...
  alphabeticallyAscending: 'Alphabetically (A-Z)',
  alphabeticallyDescending: 'Alphabetically (Z-A)',
  newestFirst: 'Newest first',
  oldestAddedFirst: 'Oldest added first',
  delete: 'Delete',
  ...
  zippedFormatsNote: 'Note: ZIP archives containing .txt, .epub, or .fb2 files are also supported',
  ...
  untitledVolume: 'Untitled Volume',
